...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_GENERATE_PKEY_KYBER, 0),
     "ssl_generate_pkey_kyber"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_GENERATE_PKEY_NTTRU, 0),
     "ssl_generate_pkey_nttru"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CKE_KYBER, 0),
     "tls_construct_cke_kyber"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CKE_NTTRU, 0),
     "tls_construct_cke_nttru"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CKE_DHE, 0),
     "tls_process_cke_dhe"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CKE_NTTRU, 0),
     "tls_process_cke_nttru"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SKE_KYBER, 0),
     "tls_process_ske_kyber"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_SKE_NTTRU, 0),
     "tls_process_ske_nttru"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_MISSING_KYBER_CERTIFICATE),
    "missing kyber certificate"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_MISSING_NTTRU_CERTIFICATE),
     "missing nttru certificate"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_MISSING_TMP_KYBER_KEY), "missing tmp kyber key"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_MISSING_TMP_NTTRU_KEY), "missing tmp nttru key"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_KYBER_CERTIFICATE_SENT_BY_PEER),
    "Peer haven't sent Kyber certificate, required for selected ciphersuite"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_NTTRU_CERTIFICATE_SENT_BY_PEER),
     "Peer haven't sent NTTRU certificate, required for selected ciphersuite"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_GENERATE_KYBER_WRAPPER),
    "unable to generate kyber wrapper"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_GENERATE_NTTRU_WRAPPER),
     "unable to generate nttru wrapper"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_KYBER_KEY), "bad kyber key"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_NTTRU_KEY), "bad nttru key"},
    {0, NULL}
};
