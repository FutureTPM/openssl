...
static const ssl_cipher_table ssl_cipher_table_auth[] = {
    ...
    {SSL_aSRP, NID_auth_srp},       {SSL_aDILITHIUM, NID_auth_dilithium},
    {SSL_aNULL, NID_auth_null},     {SSL_aANY, NID_auth_any}};
/* *INDENT-ON* */
...
const EVP_MD *ssl_handshake_md(SSL *s) { return ssl_md(ssl_get_algorithm2(s)); }
