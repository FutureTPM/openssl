...
static int ossltest_cipher_nids[] = {NID_aes_128_cbc, NID_aes_128_gcm, 0};
...
static int digest_md5_init(EVP_MD_CTX *ctx) { return MD5_Init(data(ctx)); }
...
static int digest_sha1_init(EVP_MD_CTX *ctx) { return SHA1_Init(data(ctx)); }
