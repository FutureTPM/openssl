...
static const uint32_t default_ciphers_in_order[] = {
    ...
    TLS1_CK_NTTRU_DILITHIUM_WITH_AES_256_GCM_SHA384,
    TLS1_CK_NTTRU_RSA_WITH_AES_256_GCM_SHA384,
    TLS1_CK_NTTRU_DILITHIUM_WITH_AES_128_GCM_SHA256,
    TLS1_CK_NTTRU_RSA_WITH_AES_128_GCM_SHA256,
    TLS1_CK_NTTRU_DILITHIUM_WITH_AES_256_SHA384,
    TLS1_CK_NTTRU_RSA_WITH_AES_256_SHA384,
#endif
