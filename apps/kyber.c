...
typedef enum OPTION_choice {
    ...
    OPT_KYBERPUBKEY_IN, OPT_KYBERPUBKEY_OUT,
...
const OPTIONS kyber_options[] = {
    ...
    {"KyberPublicKey_in", OPT_KYBERPUBKEY_IN, '-', "Input is an KyberPublicKey"},
    {"KyberPublicKey_out", OPT_KYBERPUBKEY_OUT, '-', "Output is an KyberPublicKey"},
 ...
 opthelp:
    ...
    if (outformat == FORMAT_ASN1) {
        ...
        if (pubout || pubin) {
            ...
            assert(private);
            i = PEM_write_bio_KyberPrivateKey(out, kyber,
